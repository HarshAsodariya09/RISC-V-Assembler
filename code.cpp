...
bool Knob3 = false; // Enable/disable printing all register file content at each cycle
bool Knob4 = false; // Enable/disable printing pipeline registers at the end of each cycle
int Knob5 = -1; // Specific instruction number to track in pipeline registers
bool Knob6 = false; // Enable/disable printing branch prediction details
